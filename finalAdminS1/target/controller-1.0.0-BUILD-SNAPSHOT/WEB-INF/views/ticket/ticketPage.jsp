		...
		<div class="panel panel-info">
			...
			<div class="panel-body">
				...
				<div class="form-group">
					...
					<input class="form-control" name="tno" value="${ticketPage.tno}" readonly>
				</div>
				
				<div class="form-group">
					<label>userId</label>
					<input class="form-control" name="userId" value="${ticketPage.userId}" readonly>
				</div>
				
				<div class="form-group">
					<label>Title</label>
					<input class="form-control" name="title" value="${ticketPage.title}" readonly>
				</div>
				...
				<input type="hidden" id='tno' name='tno' value='<c:out value="${ticketPage.tno}"/>'>
...
function showList(page){
    ...
    replyService.getList({tno:tnoValue,page: page|| 1 }, function(replyCnt, list) {
  ...
  //댓글 조회 클릭 이벤트 처리 
    ...
    modalModBtn.on("click",function(e){
        //JSON객체 생성
		var reply={rno:modal.data("rno"), reply:modalInputReply.val(), tno:tnoValue};
