...
<!-- Sidebar -->
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <!-- Sidebar - Brand -->
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/ttcarAdmin/index">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="/ttcarAdmin/index">
      ...
      <li class="nav-item">
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="/ttcarAdmin/login">Login</a>
            <a class="collapse-item" href="/ttcarAdmin/register">Register</a>
      ...
      <!-- Nav Item - Tickets -->
      <li class="nav-item">
        <a class="nav-link" href="/ttcarAdmin/ticketList">
