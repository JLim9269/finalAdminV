...
<!-- Topbar -->
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
            <div class="input-group">
              <input type="text" class="form-control bg-light border-0 small" placeholder='<spring:message code="message.admin.header-topbar.search"/>' aria-label="Search" aria-describedby="basic-addon2">
            ...
            <li class="nav-item dropdown no-arrow">
              ...
              <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                <a class="dropdown-item" href="#">
                  ...
                  <spring:message code="message.admin.header-topbar.profile"/>
                </a>
                <a class="dropdown-item" href="#">
                ...
                <div class="dropdown-divider"></div>
                <a class="dropdown-item" href="/ttcarAdmin/logout" data-toggle="modal" data-target="#logoutModal">
                  <i class="fas fa-sign-out-alt fa-sm fa-fw mr-2 text-gray-400"></i>
                  <spring:message code="message.admin.header-topbar.logout"/>
                </a>
              </div>
            </li>
        ...
        <!-- Logout Modal-->	<!-- include later if more than 1 -->
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <a class="btn btn-primary" href="/ttcarAdmin/logout">Logout</a>
        </div>
      </div>
    </div>
  </div>
